...
import type { RecipeReleases } from "../../app/api"
...
function ReleaseItem(props: {
  ...
  const displayName = () => props.release.createdBy?.name || props.release.createdBy?.email || "Unknown"
...
export function RecipeVersionControl(props: Props) {
        ...
        <Portal>
          ...
          >
            <div class="flex items-center justify-between border-b border-border px-3 py-2">
              <span class="text-xs font-medium text-text-muted">Recipe version</span>
              <button
                type="button"
